...
| 45 | `tests/fixtures/protocol/invalid_address_reuse_session.yaml` | 57 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 46 | `tests/fixtures/protocol/invalid_boolean_string.yaml` | 57 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 47 | `tests/fixtures/protocol/invalid_bounded_parallel_update.yaml` | 57 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 48 | `tests/fixtures/protocol/invalid_broadcast_response_policy.yaml` | 57 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 49 | `tests/fixtures/protocol/invalid_explicit_blank_core_profile.yaml` | 57 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 50 | `tests/fixtures/protocol/invalid_explicit_empty_core_profile.yaml` | 46 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 51 | `tests/fixtures/protocol/invalid_group_session_without_profile.yaml` | 57 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 52 | `tests/fixtures/protocol/invalid_identity_conflict_policy.yaml` | 57 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 53 | `tests/fixtures/protocol/invalid_legacy_empty_profile.yaml` | 13 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 54 | `tests/fixtures/protocol/invalid_maximum_nodes_zero.yaml` | 57 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 55 | `tests/fixtures/protocol/invalid_multi_target_partial_failure.yaml` | 57 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 56 | `tests/fixtures/protocol/invalid_scope_typo.yaml` | 57 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 57 | `tests/fixtures/protocol/invalid_shared_bus_without_addressing.yaml` | 57 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 58 | `tests/fixtures/protocol/valid_legacy_single_node.yaml` | 24 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 59 | `tests/fixtures/protocol/valid_multi_independent.yaml` | 58 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 60 | `tests/fixtures/protocol/valid_multi_shared_bus.yaml` | 57 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 61 | `tests/fixtures/protocol/valid_routed_gateway.yaml` | 58 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
| 62 | `tests/fixtures/protocol/valid_single_node.yaml` | 57 | — | — | Positive/negative protocol semantic-validation fixture | **Retire** | Do not migrate fixtures into v0.0.1; preserve scenario intent until executable-invariant extraction and a stable machine-readable contract exist. |
